...
import (
	...
	"github.com/NewAlist/alist/internal/offline_download/tool"
...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.Announcement, Value: "### repo\nhttps://github.com/NewAlist/alist", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://doc.newalist.top/logo.svg", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://doc.newalist.top/logo.svg", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//	"pdf.js":"https://NewAlist.github.io/pdf.js/web/viewer.html?file=$url"
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://doc.newalist.top/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
